...
authors a tailored harness, and a headless `claude -p` while-loop implements,
verifies, and commits every task on a dedicated branch.
...
3.965s. After many hours I took it back with a 3.959s. Then it beat me with a 3.949 again.
...
![Codex](https://img.shields.io/badge/Codex_CLI-111827?logo=openai&logoColor=white)
...
📬 Live work and demos → [michaelreinhoffer.lol](https://michaelreinhoffer.lol)
